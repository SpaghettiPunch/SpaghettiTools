...
public:
	...
	virtual FText GetAssetDisplayName() const override { return NSLOCTEXT("AssetTypeActions", "AssetTypeActions_ImageSlateBrush", "Image Slate Brush"); }
	virtual FLinearColor GetAssetColor() const override { return FLinearColor(FColor(105, 165, 60)); }
	virtual TSoftClassPtr<UObject> GetAssetClass() const override { return UImageSlateBrushAsset::StaticClass(); }
